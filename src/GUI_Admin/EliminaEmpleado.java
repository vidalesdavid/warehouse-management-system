...
public class EliminaEmpleado extends javax.swing.JFrame {
  ...
  private final Connection con;
    ...
    */
    public EliminaEmpleado(Connection con) throws SQLException  {
    ...
    private void initComponents() {
        ...
        btnEliminar.setBounds(40, 270, 90, 22);

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 18)); // NOI18N
        jLabel6.setText("Elimina Usuario");
        jPanel1.add(jLabel6);
        ...
        btnRegresar.setBounds(200, 30, 90, 30);
        ...
        jPanel1.add(comboId);
        comboId.setBounds(20, 140, 120, 22);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
      ...
      String id=(comboId.getSelectedItem().toString());
       String elimina="delete from usuarios where user='"+id+"'";
       int conf=0;
         try{
             enc.EncuentraCliente(con,"user",id+"","usuarios");
            ...
            //System.out.println(ex.getNextException());
             System.out.println(ex);
               JOptionPane.showMessageDialog(null, "No se pudo eliminar al empleado, puede que ya se haya eliminado");
            }
      try {
          obj=new ConsultaUsuarioTabla(con);
      } catch (SQLException exp) {
          Logger.getLogger(EliminaEmpleado.class.getName()).log(Level.SEVERE, null, exp);
      }
