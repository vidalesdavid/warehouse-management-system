...
/**
 *Clase para consultar la tabla Pedido de la base de datos segun
 * si los pedidos estan activos o entregados y retornar un TableModel con esa informacion
 * @author Luis David Vidales Ramírez, 183060, 183060@upslp.edu.mx
 */
public class ConsultaPedidoTablaBus {
     ...
     * @param estado Cadena que indica el estado de los pedidos que se quieren mostrar
     * @throws SQLException  Puede lanzar excepciones SQL
     */
    public ConsultaPedidoTablaBus(Connection con,String estado) throws SQLException{
        this.con=con;
        this.estado=estado;
        consultaTabla();
    }
 ...
 */
    private void consultaTabla() throws SQLException {
     ...
     try{
         ...
         while(rs.next()){
             if(rs.getString("estado").equals(estado)){
