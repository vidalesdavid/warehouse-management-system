...
/**
 *Clase para consultar la tabla Cliente de la base de datos y retornar un TableModel que permite cargar
 ...
 */
public class ConsultaClienteTabla {
     ...
     * @throws SQLException  Puede lanzar una excepcion SQL
     */
    public ConsultaClienteTabla(Connection con) throws SQLException{
        this.con=con;
        consultaTabla();
    }
    /**
